...
\begin{figure}[H] %start a figure
\begin{center}
<<eval=FALSE,echo=FALSE,fig=TRUE,warning=TRUE,error=TRUE, out.width = "1\\linewidth", fig.height=4>>=
...
\begin{figure}[H] %start a figure
\begin{center}
<<eval=TRUE,echo=TRUE,fig=TRUE, out.width = "1\\linewidth", fig.height=4>>=

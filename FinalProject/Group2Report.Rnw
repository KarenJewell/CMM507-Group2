...
\begin{center}
<<eval=FALSE, fig=TRUE,warning=FALSE,message=FALSE,echo=TRUE,out.width=".47\\linewidth">>=
...
<<warning=FALSE,message=FALSE,eval=FALSE,echo=TRUE,results='asis'>>=
require(openxlsx);
require(readxl)
...
<<eval=FALSE, fig=TRUE,warning=FALSE,message=FALSE,echo=FALSE,out.width=".47\\linewidth">>=

...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xtable(head(actuals\_preds)): could not find function "{}xtable"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: package or namespace load failed for 'XLConnect':\\\#\#\ \ .onLoad failed in loadNamespace() for 'rJava', details:\\\#\#\ \  call: fun(libname, pkgname)\\\#\#\ \  error: JAVA\_HOME cannot be determined from the Registry}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in readWorksheet(loadWorkbook("{}data/meetings.xlsx"{}), sheet = 1): could not find function "{}readWorksheet"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'dfs' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in readWorksheet(loadWorkbook("{}data/peers.xlsx"{}), sheet = 1): could not find function "{}readWorksheet"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(dfs[, ], as.character): object 'dfs' not found}}
